            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-xs-12">
                                ...
                                <br>
                      <span class = 'iconEdit'> <button type="button" data-toggle='modal' data-target='#myModal' class="btn btn-default">
  Upload file
</button> </span>
<br><br>
    ...
    <div class="input-group">
        ...
        <div class = 'row'>
            <div class = 'col-lg-12 col-xs-12'>
                    ...
                    <?php
                        while($row = mysqli_fetch_array($objQuery)){
                            echo "<a href= 'uploadPhoto.php?q=".$row['subject_seq']."'' class='list-group-item'>";
                            //echo "<tr><td style ='text-align: left;' colspan = '2'>";
                            //echo "<option value = '".$row['subject_seq']."'>";
                            echo  $row['subject_name']."</a>"; 
                        }
                    ...
                    ?>
                     ...
                     <!-- <tr><td colspan = '2'>System Analysis And Design</td></tr>  -->
